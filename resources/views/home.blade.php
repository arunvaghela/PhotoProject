    ...
    <section class="pricing section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 mb-30">
                    <p>The best prices for your relaxing vacation curabit aliquet orci elit gene tristique in lorem
                        dream vitae alisuam tincidunt felis sed gravida aliquam nesue libero hendreri mana the amenta
                        the mollis lacus tuam maurisine. Alituam erat volutsat.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="pricing left">
                            ...
                            <div class="caption padding-left">
                                ...
                                <p class="white">Curabit aliquet orci elit gene on tristique in the dream vitaen.
                                    Aliquam tincidunt, felis sed gravida aliquam the neque miss hendrerit magna sit
                                    amenta the mollis lacus.</p>
    ...
    <section class="blog section-padding bg-green">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 mb-30">
                    <p class="white">Wedding Tips, inspiration and bridal reports. Curabit aliquet orci elit gene
                        tristique lorem dream vitae situam tincidun felis sed gravida alisuam nemue libero hendrerit
                        maina into amenta the mollis lacus quam maurisine in the miss erat volutpat.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="position-re o-hidden"><img src="{{url('assets/img/slider/18.jpg')}}" alt="">
                            </div>
                            <div class="con">
                                <span class="category">10 Dec 2024 in <a href="#0">Trouwtips</a></span>
                                <h5><a href="post.html">5 Tips On How To Be The Best Groomsman Ever</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"><img src="{{url('assets/img/slider/5.jpg')}}" alt="">
                            </div>
                            <div class="con">
                                <span class="category">12 Dec 2024 in <a href="#0">Wedding Tips</a></span>
                                <h5><a href="post.html">5 tips for a successful multilingual wedding ceremony</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"><img src="{{url('assets/img/slider/6.jpg')}}" alt="">
                            </div>
                            <div class="con">
                                <span class="category">15 Dec 2024 in <a href="#0">Trouwtips</a></span>
                                <h5><a href="post.html">Is it possible to plan a wedding in 3 months?</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"><img src="{{url('assets/img/slider/10.jpg')}}" alt="">
                            </div>
                            <div class="con">
                                <span class="category">18 Dec 2024 in <a href="#0">Wedding</a></span>
                                <h5><a href="post.html">20 Rules For How To Be The Perfect Bridesmaid</a></h5>
                            </div>
                        </div>

                        <div class="item">
                            <div class="position-re o-hidden"><img src="{{url('assets/img/slider/19.jpg')}}" alt="">
                            </div>
                            <div class="con">
                                <span class="category">20 Dec 2024 in <a href="#0">Wedding</a></span>
                                <h5><a href="post.html">How to Keep Motivated as a Wedding Planner</a></h5>
                            </div>
                        </div>
                        <div class="item">
                            <div class="position-re o-hidden"><img src="{{url('assets/img/slider/17.jpg')}}" alt="">
                            </div>
